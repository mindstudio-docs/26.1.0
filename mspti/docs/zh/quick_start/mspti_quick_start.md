...
- **PyTorch + torch_npu**（可选）：Python Monitor 样例依赖 PyTorch 框架和 TorchNPU（[安装指南](https://gitcode.com/Ascend/pytorch/blob/v2.7.1-26.1.0/docs/zh/installation_guide/installation_description.md)）。
