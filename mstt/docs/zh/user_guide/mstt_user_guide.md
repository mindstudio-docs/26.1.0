...
|                          我要做什么                          | 推荐工具                                                     | 为什么推荐                                                   |
| :----------------------------------------------------------: | :----------------------------------------------------------- | :----------------------------------------------------------- |
|           我想将GPU的训练或推理脚本迁移到NPU上运行           | [**msTransplant**](https://gitcode.com/Ascend/mstt/tree/26.1.0/msfmktransplt) | PyTorch训练脚本一键迁移至昇腾NPU，支持少量改码或零改码完成迁移 |
...
|        我想做MindSpeed-LLM训练任务并行策略的自动寻优         | [**Tinker**](https://gitcode.com/Ascend/mstt/tree/26.1.0/profiler/tinker) | 按训练脚本做单节点NPU测评并推荐高性能并行方案                |
|             我想在HostBound场景做CPU绑核提升性能             | [**bind_core**](https://gitcode.com/Ascend/mstt/tree/26.1.0/profiler/affinity_cpu_bind) | 无需侵入修改工程即可按CPU亲和性策略绑核                      |
