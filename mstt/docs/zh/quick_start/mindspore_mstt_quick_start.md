...
4. 查看结果。
   ...
   **图1** 结果文件内容
   ...
   输出结果详细介绍请参见“[输出结果](https://gitcode.com/Ascend/msprobe/blob/26.1.0/docs/zh/user_guide/monitor_v2_instruct.md#输出结果)”。
...
预检结果详细介绍请参见“[预检结果](https://gitcode.com/Ascend/msprobe/blob/26.1.0/docs/zh/user_guide/accuracy_checker/mindspore_accuracy_checker_instruct.md#%E9%A2%84%E6%A3%80%E7%BB%93%E6%9E%9C)”。
...
3. 比对结果文件分析。
   ...
   **图2** compare_result_3
   ...
   更多比对结果分析请参见“[输出结果文件说明](https://gitcode.com/Ascend/msprobe/blob/26.1.0/docs/zh/user_guide/accuracy_compare/pytorch_accuracy_compare_instruct.md#%E8%BE%93%E5%87%BA%E7%BB%93%E6%9E%9C%E6%96%87%E4%BB%B6%E8%AF%B4%E6%98%8E)”。
...
1. 安装MindStudio Insight。
   ...
   参见《[MindStudio Insight工具用户指南](https://gitcode.com/Ascend/msinsight/blob/26.1.0/docs/zh/install_guide/mindstudio_insight_install_guide.md)》下载并安装MindStudio Insight。
...
4. 分析性能数据。
   ...
   MindStudio Insight工具将性能数据可视化后可以更直观地分析性能瓶颈，详细分析方法请参见《[MindStudio Insight工具用户指南](https://gitcode.com/Ascend/msinsight/blob/26.1.0/README.md)》。
