...
- Install the msModelSlim software. For details, see [msModelSlim Installation Guide](https://gitcode.com/Ascend/msmodelslim/blob/26.1.0/docs/en/getting_started/install_guide.md).
